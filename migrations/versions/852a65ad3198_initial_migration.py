...
Revision ID: 852a65ad3198
Revises: 
Create Date: 2024-04-24 16:45:48.630942
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('type', sa.Enum('SCREENSHOT', 'MICROPHONE', 'BROWSER_DATA', name='commandtype'),
                              nullable=False),
